...
# save results
os.makedirs("results/eval_pararel/llama3/results/llama3/pararel_batch10_53_strict_answer_se_1", exist_ok=True)
json.dump(rft_pararel_results, open("results/eval_pararel/llama3/results/llama3/pararel_batch10_53_strict_answer_se_1/OOD_pararel.json", "w"), indent=4)
