...
# 定义测试数据集
datasets = [
    "dataset/ID_test_pararel.json"
]

# 创建输出目录
os.makedirs("evaluate/llama3/pararel/llama3_8b/ID", exist_ok=True)
os.makedirs("evaluate/llama3/pararel/llama3_8b/OOD", exist_ok=True)
