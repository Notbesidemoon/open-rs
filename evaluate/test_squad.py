...
# 解析命令行参数
parser = argparse.ArgumentParser(description="测试模型在squad数据集上的表现")
...
parser.add_argument("--output_path", type=str, default='evaluate/llama3/squad/pararel_trained_rft_squad_results.json', help="结果保存路径")
parser.add_argument("--gpu_id", type=str, default='1', help="使用的GPU ID")
...
# 加载数据集
dataset = datasets.load_dataset("rajpurkar/squad_v2")['validation']
